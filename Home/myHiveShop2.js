...
// export default function MyHiveShop2() {
//   const [buyModal, setBuyModal] = useState(false)  
//   const [myShopList2, setMyShopList2] = useState({
//       counters : [
//             { id: 0, value: 0, name: 'Chin', price: 130     },
//             { id: 1, value: 0, name:'Saguaro', price: 150       },
//             { id: 2, value: 0, name: 'Star', price: 100      },
//             { id: 3, value: 0, name: 'Moon', price: 200 },
//             { id: 4, value: 0, name: 'Barrel', price: 70    },
//       ]}
//       );
//   //Clona el state para así incrementar el value de algún objeto.
//   const handleIncrement = (counter) => {
//     const counters = [...myShopList2.counters];
//     const index = counters.indexOf(counter);
//     counters[index]={...counter}; 
//     counters[index].value++;
//     setMyShopList2({counters})
//   };
//   //Función para resetear los elementos a 0
//   const handleReset = () => {
//     const counters = myShopList2.counters.map((c) => {
//       c.value = 0;
//       return c;
//     });
//     setMyShopList2({counters});
...
//   const result = () => {       
//     const result =  myShopList2.counters.filter(c => c.value>0).reduce((t,c ) => t + c.price * c.value, 0);
//     return result;
//   }
//   //Función que devuelve el total de elementos comprados
//   const totalCounters = () =>{
//     const totalCounters = myShopList2.counters.filter(c=> c.value>0).length;
